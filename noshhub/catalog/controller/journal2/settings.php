...
class ControllerJournal2Settings extends Controller {
    ...
    public function index() {
        ...
        $html .= '<a class="button notification-cart" href="' . $this->url->link('checkout/cart') . '">' . $this->language->get('text_cart') . '</a>';
        $html .= '<a class="button notification-checkout" href="' . $this->url->link('checkout/checkout', '', 'SSL') . '">' . $this->language->get('text_checkout') . '</a>';
        $html .= '</div>';
