<div class="box <?php echo $carousel ? 'journal-carousel' : ''; ?> static-banners <?php echo $hide_on_mobile_class; ?> <?php echo isset($gutter_on_class) ? $gutter_on_class : ''; ?>" style="<?php echo isset($css) ? $css : ''; ?>" id="static-banners-<?php echo $module; ?>" >
    <div>
        <?php if ($title): ?>
